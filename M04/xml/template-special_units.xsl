    ...
    <xsl:template match="/special_units">
        <html>
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="css/special_units.css" />
            ...
            <body>
                <div class="contendor">
                    ...
                    <div class="contenedorSpecialUnits">
                        <xsl:for-each select="unit">
                            <div class="contenedorSpecialUnit">
                                <div class= "contenidoSpecialUnit">
