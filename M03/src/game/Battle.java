...
//			}
//			getInitialArmies()[0][i] = civilizationArmy[i].size(); // añade la cantidad de soldados
...
//			int totalSoldados = 0;
//			for (int i = 0; i < armies[0].length; i++) { // Vamos sumando los soldados por tipos
//				System.out.println(armies[0]);
//				if (armies[0][i] != null) {
//					totalSoldados += armies[0][i].size();
//				}
//			}
//			if (totalSoldados == 0) { // Comprueba si nuestra civilizacion esta por encima del 20%
//				battleover = true;
//			}
//
//			totalSoldados = 0;
//			for (int i = 0; i < armies[1].length; i++) { // Vamos sumando los soldados por tipos
//				System.out.println(armies[1]);
//				if (armies[1][i] != null) {
//					totalSoldados += armies[1][i].size();
//				}
//			}
//			if (totalSoldados == 0) { // Comprueba si nuestra civilizacion esta por encima del 20%
//				battleover = true;
