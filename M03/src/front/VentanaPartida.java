...
public class VentanaPartida extends JFrame implements ActionListener {
	...
	private JLabel lSwordsmanBattle, lSpearmanBattle, lCrossbowBattle, lCannonBattle, lArrowTowerBattle, lCatapultBattle,
			lRocketLauncherTowerBattle, lMagicianBattle, lPriestBattle, lSwordsmanEnemy, lSpearmanEnemy, lCrossbowEnemy, lCannonEnemy; // label
																																		// para
																																		// battleground
	...
	public VentanaPartida(int id) {
		...
		lAttackFoodCost.setBounds(390 + insets.left, 470 + insets.top, size.width, size.height);
		size = lAttackWoodCost.getPreferredSize();
		lAttackWoodCost.setBounds(390 + insets.left, 490 + insets.top, size.width, size.height);
		size = lAttackIronCost.getPreferredSize();
		lAttackIronCost.setBounds(390 + insets.left, 510 + insets.top, size.width, size.height);
		size = lDefenseFoodCost.getPreferredSize();
		lDefenseFoodCost.setBounds(390 + insets.left, 557 + insets.top, size.width, size.height);
		size = lDefenseWoodCost.getPreferredSize();
		lDefenseWoodCost.setBounds(390 + insets.left, 577 + insets.top, size.width, size.height);
		size = lDefenseIronCost.getPreferredSize();
		lDefenseIronCost.setBounds(390 + insets.left, 597 + insets.top, size.width, size.height);
